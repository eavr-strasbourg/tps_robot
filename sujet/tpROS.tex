...
\begin{itemize}
\item \texttt{/joint\_state\_publisher} : interface des sliders. Publie sur \texttt{/joint\_state\_publisher/manual} les positions articulaires correspondant aux sliders.
...
\item \texttt{/joint\_state\_publisher/switch} : envoie au simulateur les positions manuelles ou bien celles qui viennent de la loi de commande
\begin{itemize}
