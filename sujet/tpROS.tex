...
On reconnaît le fichier \texttt{configure.py} qui a été lancé en première séance pour initialiser l'environnement.
...
Utiliser \texttt{rqt\_plot} pour visualiser l'effet d'un conflit de publication (plusieurs nodes publiant sur le même topic sans se concerter).
\end{enumerate}
