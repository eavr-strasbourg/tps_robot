...
\begin{itemize}
\item Avec \texttt{File/Open file}, choisir le fichier \texttt{CMakeList.txt} du package tps\_robot
 \item Indiquer \texttt{tps\_robot/build} comme répertoire de compilation
